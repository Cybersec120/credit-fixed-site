    ...
    <section>
      <div class="container" style="padding: 48px 0;">
        <div style="max-width: 560px; margin: 0 auto; text-align: center;">
          <h2>View Our Full Tradeline Inventory</h2>
          <p class="small">
            Pricing varies by tradeline age, credit limit, and reporting bureau.
            Browse our current inventory and pricing below.
          </p>
          <p style="margin-top:16px;"><a href="/tradeline-list.html" class="btn btn-gold">View Full Inventory &amp; Pricing</a></p>
        </div>

        <div style="max-width: 560px; margin: 32px auto 0; text-align: center;">
          <h3>Have questions first? Reach out directly.</h3>
        </div>
